...
const Dashboard = () => {
  // State management and API call setup
  ...
  return (
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="flex items-center p-8 bg-white bg-opacity-20 backdrop-blur-lg shadow-lg rounded-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
          ...
          <div>
            ...
            <a href='/'><span className="block text-gray-500">Products</span></a>
